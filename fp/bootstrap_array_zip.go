...
func (a BoolArray) ZipBoolArrayArray(a2 BoolArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a BoolArray) ZipStringArrayArray(a2 StringArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a BoolArray) ZipIntArrayArray(a2 IntArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a BoolArray) ZipInt64ArrayArray(a2 Int64ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a BoolArray) ZipByteArrayArray(a2 ByteArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a BoolArray) ZipRuneArrayArray(a2 RuneArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a BoolArray) ZipFloat32ArrayArray(a2 Float32ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a BoolArray) ZipFloat64ArrayArray(a2 Float64ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a BoolArray) ZipAnyArrayArray(a2 AnyArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a BoolArray) ZipTuple2ArrayArray(a2 Tuple2ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a StringArray) ZipBoolArrayArray(a2 BoolArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a StringArray) ZipStringArrayArray(a2 StringArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a StringArray) ZipIntArrayArray(a2 IntArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a StringArray) ZipInt64ArrayArray(a2 Int64ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a StringArray) ZipByteArrayArray(a2 ByteArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a StringArray) ZipRuneArrayArray(a2 RuneArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a StringArray) ZipFloat32ArrayArray(a2 Float32ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a StringArray) ZipFloat64ArrayArray(a2 Float64ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a StringArray) ZipAnyArrayArray(a2 AnyArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a StringArray) ZipTuple2ArrayArray(a2 Tuple2ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a IntArray) ZipBoolArrayArray(a2 BoolArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a IntArray) ZipStringArrayArray(a2 StringArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a IntArray) ZipIntArrayArray(a2 IntArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a IntArray) ZipInt64ArrayArray(a2 Int64ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a IntArray) ZipByteArrayArray(a2 ByteArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a IntArray) ZipRuneArrayArray(a2 RuneArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a IntArray) ZipFloat32ArrayArray(a2 Float32ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a IntArray) ZipFloat64ArrayArray(a2 Float64ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a IntArray) ZipAnyArrayArray(a2 AnyArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a IntArray) ZipTuple2ArrayArray(a2 Tuple2ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Int64Array) ZipBoolArrayArray(a2 BoolArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Int64Array) ZipStringArrayArray(a2 StringArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Int64Array) ZipIntArrayArray(a2 IntArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Int64Array) ZipInt64ArrayArray(a2 Int64ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Int64Array) ZipByteArrayArray(a2 ByteArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Int64Array) ZipRuneArrayArray(a2 RuneArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Int64Array) ZipFloat32ArrayArray(a2 Float32ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Int64Array) ZipFloat64ArrayArray(a2 Float64ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Int64Array) ZipAnyArrayArray(a2 AnyArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Int64Array) ZipTuple2ArrayArray(a2 Tuple2ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a ByteArray) ZipBoolArrayArray(a2 BoolArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a ByteArray) ZipStringArrayArray(a2 StringArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a ByteArray) ZipIntArrayArray(a2 IntArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a ByteArray) ZipInt64ArrayArray(a2 Int64ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a ByteArray) ZipByteArrayArray(a2 ByteArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a ByteArray) ZipRuneArrayArray(a2 RuneArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a ByteArray) ZipFloat32ArrayArray(a2 Float32ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a ByteArray) ZipFloat64ArrayArray(a2 Float64ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a ByteArray) ZipAnyArrayArray(a2 AnyArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a ByteArray) ZipTuple2ArrayArray(a2 Tuple2ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a RuneArray) ZipBoolArrayArray(a2 BoolArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a RuneArray) ZipStringArrayArray(a2 StringArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a RuneArray) ZipIntArrayArray(a2 IntArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a RuneArray) ZipInt64ArrayArray(a2 Int64ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a RuneArray) ZipByteArrayArray(a2 ByteArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a RuneArray) ZipRuneArrayArray(a2 RuneArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a RuneArray) ZipFloat32ArrayArray(a2 Float32ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a RuneArray) ZipFloat64ArrayArray(a2 Float64ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a RuneArray) ZipAnyArrayArray(a2 AnyArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a RuneArray) ZipTuple2ArrayArray(a2 Tuple2ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Float32Array) ZipBoolArrayArray(a2 BoolArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Float32Array) ZipStringArrayArray(a2 StringArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Float32Array) ZipIntArrayArray(a2 IntArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Float32Array) ZipInt64ArrayArray(a2 Int64ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Float32Array) ZipByteArrayArray(a2 ByteArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Float32Array) ZipRuneArrayArray(a2 RuneArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Float32Array) ZipFloat32ArrayArray(a2 Float32ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Float32Array) ZipFloat64ArrayArray(a2 Float64ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Float32Array) ZipAnyArrayArray(a2 AnyArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Float32Array) ZipTuple2ArrayArray(a2 Tuple2ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Float64Array) ZipBoolArrayArray(a2 BoolArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Float64Array) ZipStringArrayArray(a2 StringArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Float64Array) ZipIntArrayArray(a2 IntArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Float64Array) ZipInt64ArrayArray(a2 Int64ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Float64Array) ZipByteArrayArray(a2 ByteArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Float64Array) ZipRuneArrayArray(a2 RuneArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Float64Array) ZipFloat32ArrayArray(a2 Float32ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Float64Array) ZipFloat64ArrayArray(a2 Float64ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Float64Array) ZipAnyArrayArray(a2 AnyArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Float64Array) ZipTuple2ArrayArray(a2 Tuple2ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a AnyArray) ZipBoolArrayArray(a2 BoolArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a AnyArray) ZipStringArrayArray(a2 StringArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a AnyArray) ZipIntArrayArray(a2 IntArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a AnyArray) ZipInt64ArrayArray(a2 Int64ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a AnyArray) ZipByteArrayArray(a2 ByteArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a AnyArray) ZipRuneArrayArray(a2 RuneArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a AnyArray) ZipFloat32ArrayArray(a2 Float32ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a AnyArray) ZipFloat64ArrayArray(a2 Float64ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a AnyArray) ZipAnyArrayArray(a2 AnyArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a AnyArray) ZipTuple2ArrayArray(a2 Tuple2ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Tuple2Array) ZipBoolArrayArray(a2 BoolArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Tuple2Array) ZipStringArrayArray(a2 StringArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Tuple2Array) ZipIntArrayArray(a2 IntArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Tuple2Array) ZipInt64ArrayArray(a2 Int64ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Tuple2Array) ZipByteArrayArray(a2 ByteArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Tuple2Array) ZipRuneArrayArray(a2 RuneArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Tuple2Array) ZipFloat32ArrayArray(a2 Float32ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Tuple2Array) ZipFloat64ArrayArray(a2 Float64ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Tuple2Array) ZipAnyArrayArray(a2 AnyArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
...
func (a Tuple2Array) ZipTuple2ArrayArray(a2 Tuple2ArrayArray) Tuple2Array {
	minLen := int(Int(len(a)).Min(Int(len(a2))))
	zipped := make([]Tuple2, minLen)
	for i := 0; i < minLen; i++ {
		zipped[i] = Tuple2{a[i], a2[i]}
