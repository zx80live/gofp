...
func (a Int) Min(b Int) Int {if a <= b { return a } else { return b}}
func (a Int64) Min(b Int64) Int64 {if a <= b { return a } else { return b}}
func (a Byte) Min(b Byte) Byte {if a <= b { return a } else { return b}}
func (a Rune) Min(b Rune) Rune {if a <= b { return a } else { return b}}
func (a Float32) Min(b Float32) Float32 {if a <= b { return a } else { return b}}
func (a Float64) Min(b Float64) Float64 {if a <= b { return a } else { return b}}
func (a Int) Max(b Int) Int {if a > b { return a } else { return b}}
func (a Int64) Max(b Int64) Int64 {if a > b { return a } else { return b}}
func (a Byte) Max(b Byte) Byte {if a > b { return a } else { return b}}
func (a Rune) Max(b Rune) Rune {if a > b { return a } else { return b}}
func (a Float32) Max(b Float32) Float32 {if a > b { return a } else { return b}}
func (a Float64) Max(b Float64) Float64 {if a > b { return a } else { return b}}
...
func (a Int16) IsBetweenInclusive(left, right int16) bool { return int16(a) >= left && int16(a) <= right }
func (a Int32) IsBetweenInclusive(left, right int32) bool { return int32(a) >= left && int32(a) <= right }
func (a Int64) IsBetweenInclusive(left, right int64) bool { return int64(a) >= left && int64(a) <= right }
func (a Uint) IsBetweenInclusive(left, right uint) bool { return uint(a) >= left && uint(a) <= right }
func (a Uint8) IsBetweenInclusive(left, right uint8) bool { return uint8(a) >= left && uint8(a) <= right }
func (a Uint16) IsBetweenInclusive(left, right uint16) bool { return uint16(a) >= left && uint16(a) <= right }
func (a Uint32) IsBetweenInclusive(left, right uint32) bool { return uint32(a) >= left && uint32(a) <= right }
func (a Uint64) IsBetweenInclusive(left, right uint64) bool { return uint64(a) >= left && uint64(a) <= right }
func (a Uintptr) IsBetweenInclusive(left, right uintptr) bool { return uintptr(a) >= left && uintptr(a) <= right }
...
func (a Float32) IsBetweenInclusive(left, right float32) bool { return float32(a) >= left && float32(a) <= right }
func (a Float64) IsBetweenInclusive(left, right float64) bool { return float64(a) >= left && float64(a) <= right }