...
func MkStringBoolOptionOptionOptionList(o BoolOptionOptionOptionList, start, sep, end string) string {
...
func MkStringStringOptionOptionOptionList(o StringOptionOptionOptionList, start, sep, end string) string {
...
func MkStringIntOptionOptionOptionList(o IntOptionOptionOptionList, start, sep, end string) string {
...
func MkStringInt8OptionOptionOptionList(o Int8OptionOptionOptionList, start, sep, end string) string {
...
func MkStringInt16OptionOptionOptionList(o Int16OptionOptionOptionList, start, sep, end string) string {
...
func MkStringInt32OptionOptionOptionList(o Int32OptionOptionOptionList, start, sep, end string) string {
...
func MkStringInt64OptionOptionOptionList(o Int64OptionOptionOptionList, start, sep, end string) string {
...
func MkStringUintOptionOptionOptionList(o UintOptionOptionOptionList, start, sep, end string) string {
...
func MkStringUint8OptionOptionOptionList(o Uint8OptionOptionOptionList, start, sep, end string) string {
...
func MkStringUint16OptionOptionOptionList(o Uint16OptionOptionOptionList, start, sep, end string) string {
...
func MkStringUint32OptionOptionOptionList(o Uint32OptionOptionOptionList, start, sep, end string) string {
...
func MkStringUint64OptionOptionOptionList(o Uint64OptionOptionOptionList, start, sep, end string) string {
...
func MkStringUintptrOptionOptionOptionList(o UintptrOptionOptionOptionList, start, sep, end string) string {
...
func MkStringByteOptionOptionOptionList(o ByteOptionOptionOptionList, start, sep, end string) string {
...
func MkStringRuneOptionOptionOptionList(o RuneOptionOptionOptionList, start, sep, end string) string {
...
func MkStringFloat32OptionOptionOptionList(o Float32OptionOptionOptionList, start, sep, end string) string {
...
func MkStringFloat64OptionOptionOptionList(o Float64OptionOptionOptionList, start, sep, end string) string {
...
func MkStringComplex64OptionOptionOptionList(o Complex64OptionOptionOptionList, start, sep, end string) string {
...
func MkStringComplex128OptionOptionOptionList(o Complex128OptionOptionOptionList, start, sep, end string) string {
...
func MkStringAnyOptionOptionOptionList(o AnyOptionOptionOptionList, start, sep, end string) string {
...
func MkStringBoolArrOptionOptionOptionList(o BoolArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, BoolArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringStringArrOptionOptionOptionList(o StringArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, StringArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringIntArrOptionOptionOptionList(o IntArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, IntArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringInt8ArrOptionOptionOptionList(o Int8ArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Int8ArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringInt16ArrOptionOptionOptionList(o Int16ArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Int16ArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringInt32ArrOptionOptionOptionList(o Int32ArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Int32ArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringInt64ArrOptionOptionOptionList(o Int64ArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Int64ArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringUintArrOptionOptionOptionList(o UintArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, UintArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringUint8ArrOptionOptionOptionList(o Uint8ArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Uint8ArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringUint16ArrOptionOptionOptionList(o Uint16ArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Uint16ArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringUint32ArrOptionOptionOptionList(o Uint32ArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Uint32ArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringUint64ArrOptionOptionOptionList(o Uint64ArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Uint64ArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringUintptrArrOptionOptionOptionList(o UintptrArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, UintptrArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringByteArrOptionOptionOptionList(o ByteArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, ByteArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringRuneArrOptionOptionOptionList(o RuneArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, RuneArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringFloat32ArrOptionOptionOptionList(o Float32ArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Float32ArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringFloat64ArrOptionOptionOptionList(o Float64ArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Float64ArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringComplex64ArrOptionOptionOptionList(o Complex64ArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Complex64ArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringComplex128ArrOptionOptionOptionList(o Complex128ArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Complex128ArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringAnyArrOptionOptionOptionList(o AnyArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, AnyArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringBoolArrArrOptionOptionOptionList(o BoolArrArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, BoolArrArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringStringArrArrOptionOptionOptionList(o StringArrArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, StringArrArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringIntArrArrOptionOptionOptionList(o IntArrArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, IntArrArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringInt8ArrArrOptionOptionOptionList(o Int8ArrArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Int8ArrArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringInt16ArrArrOptionOptionOptionList(o Int16ArrArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Int16ArrArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringInt32ArrArrOptionOptionOptionList(o Int32ArrArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Int32ArrArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringInt64ArrArrOptionOptionOptionList(o Int64ArrArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Int64ArrArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringUintArrArrOptionOptionOptionList(o UintArrArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, UintArrArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringUint8ArrArrOptionOptionOptionList(o Uint8ArrArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Uint8ArrArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringUint16ArrArrOptionOptionOptionList(o Uint16ArrArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Uint16ArrArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringUint32ArrArrOptionOptionOptionList(o Uint32ArrArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Uint32ArrArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringUint64ArrArrOptionOptionOptionList(o Uint64ArrArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Uint64ArrArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringUintptrArrArrOptionOptionOptionList(o UintptrArrArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, UintptrArrArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringByteArrArrOptionOptionOptionList(o ByteArrArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, ByteArrArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringRuneArrArrOptionOptionOptionList(o RuneArrArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, RuneArrArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringFloat32ArrArrOptionOptionOptionList(o Float32ArrArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Float32ArrArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringFloat64ArrArrOptionOptionOptionList(o Float64ArrArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Float64ArrArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringComplex64ArrArrOptionOptionOptionList(o Complex64ArrArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Complex64ArrArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringComplex128ArrArrOptionOptionOptionList(o Complex128ArrArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Complex128ArrArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringAnyArrArrOptionOptionOptionList(o AnyArrArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, AnyArrArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringBoolOptionArrOptionOptionOptionList(o BoolOptionArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, BoolOptionArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringStringOptionArrOptionOptionOptionList(o StringOptionArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, StringOptionArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringIntOptionArrOptionOptionOptionList(o IntOptionArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, IntOptionArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringInt8OptionArrOptionOptionOptionList(o Int8OptionArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Int8OptionArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringInt16OptionArrOptionOptionOptionList(o Int16OptionArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Int16OptionArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringInt32OptionArrOptionOptionOptionList(o Int32OptionArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Int32OptionArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringInt64OptionArrOptionOptionOptionList(o Int64OptionArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Int64OptionArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringUintOptionArrOptionOptionOptionList(o UintOptionArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, UintOptionArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringUint8OptionArrOptionOptionOptionList(o Uint8OptionArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Uint8OptionArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringUint16OptionArrOptionOptionOptionList(o Uint16OptionArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Uint16OptionArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringUint32OptionArrOptionOptionOptionList(o Uint32OptionArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Uint32OptionArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringUint64OptionArrOptionOptionOptionList(o Uint64OptionArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Uint64OptionArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringUintptrOptionArrOptionOptionOptionList(o UintptrOptionArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, UintptrOptionArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringByteOptionArrOptionOptionOptionList(o ByteOptionArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, ByteOptionArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringRuneOptionArrOptionOptionOptionList(o RuneOptionArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, RuneOptionArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringFloat32OptionArrOptionOptionOptionList(o Float32OptionArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Float32OptionArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringFloat64OptionArrOptionOptionOptionList(o Float64OptionArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Float64OptionArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringComplex64OptionArrOptionOptionOptionList(o Complex64OptionArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Complex64OptionArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringComplex128OptionArrOptionOptionOptionList(o Complex128OptionArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, Complex128OptionArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringAnyOptionArrOptionOptionOptionList(o AnyOptionArrOptionOptionOptionList, start, sep, end string) string {

	content := ""
	xs := o
	for xs.NonEmpty() {
		content = fmt.Sprintf("%v%v%v", content, AnyOptionArrOptionOptionOptionToString(*xs.head), sep)
		xs = *xs.tail
	}
	l := len(content)
	if l > 0 {
...
func MkStringBoolListOptionOptionOptionList(o BoolListOptionOptionOptionList, start, sep, end string) string {
...
func MkStringStringListOptionOptionOptionList(o StringListOptionOptionOptionList, start, sep, end string) string {
...
func MkStringIntListOptionOptionOptionList(o IntListOptionOptionOptionList, start, sep, end string) string {
...
func MkStringInt8ListOptionOptionOptionList(o Int8ListOptionOptionOptionList, start, sep, end string) string {
...
func MkStringInt16ListOptionOptionOptionList(o Int16ListOptionOptionOptionList, start, sep, end string) string {
...
func MkStringInt32ListOptionOptionOptionList(o Int32ListOptionOptionOptionList, start, sep, end string) string {
...
func MkStringInt64ListOptionOptionOptionList(o Int64ListOptionOptionOptionList, start, sep, end string) string {
...
func MkStringUintListOptionOptionOptionList(o UintListOptionOptionOptionList, start, sep, end string) string {
...
func MkStringUint8ListOptionOptionOptionList(o Uint8ListOptionOptionOptionList, start, sep, end string) string {
...
func MkStringUint16ListOptionOptionOptionList(o Uint16ListOptionOptionOptionList, start, sep, end string) string {
...
func MkStringUint32ListOptionOptionOptionList(o Uint32ListOptionOptionOptionList, start, sep, end string) string {
...
func MkStringUint64ListOptionOptionOptionList(o Uint64ListOptionOptionOptionList, start, sep, end string) string {
...
func MkStringUintptrListOptionOptionOptionList(o UintptrListOptionOptionOptionList, start, sep, end string) string {
...
func MkStringByteListOptionOptionOptionList(o ByteListOptionOptionOptionList, start, sep, end string) string {
...
func MkStringRuneListOptionOptionOptionList(o RuneListOptionOptionOptionList, start, sep, end string) string {
...
func MkStringFloat32ListOptionOptionOptionList(o Float32ListOptionOptionOptionList, start, sep, end string) string {
...
func MkStringFloat64ListOptionOptionOptionList(o Float64ListOptionOptionOptionList, start, sep, end string) string {
...
func MkStringComplex64ListOptionOptionOptionList(o Complex64ListOptionOptionOptionList, start, sep, end string) string {
...
func MkStringComplex128ListOptionOptionOptionList(o Complex128ListOptionOptionOptionList, start, sep, end string) string {
...
func MkStringAnyListOptionOptionOptionList(o AnyListOptionOptionOptionList, start, sep, end string) string {
