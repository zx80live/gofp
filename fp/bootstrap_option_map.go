...
func (m BoolOption) MapBool(f func(bool) bool) BoolOption {
  if m.IsDefined() { return MkBoolOption(f(*m.value)) } else { return NoneBool } }
func (m BoolOption) MapString(f func(bool) string) StringOption {
  if m.IsDefined() { return MkStringOption(f(*m.value)) } else { return NoneString } }
func (m BoolOption) MapInt(f func(bool) int) IntOption {
  if m.IsDefined() { return MkIntOption(f(*m.value)) } else { return NoneInt } }
func (m BoolOption) MapInt64(f func(bool) int64) Int64Option {
  if m.IsDefined() { return MkInt64Option(f(*m.value)) } else { return NoneInt64 } }
func (m BoolOption) MapByte(f func(bool) byte) ByteOption {
  if m.IsDefined() { return MkByteOption(f(*m.value)) } else { return NoneByte } }
func (m BoolOption) MapRune(f func(bool) rune) RuneOption {
  if m.IsDefined() { return MkRuneOption(f(*m.value)) } else { return NoneRune } }
func (m BoolOption) MapFloat32(f func(bool) float32) Float32Option {
  if m.IsDefined() { return MkFloat32Option(f(*m.value)) } else { return NoneFloat32 } }
func (m BoolOption) MapFloat64(f func(bool) float64) Float64Option {
  if m.IsDefined() { return MkFloat64Option(f(*m.value)) } else { return NoneFloat64 } }
func (m BoolOption) MapAny(f func(bool) Any) AnyOption {
  if m.IsDefined() { return MkAnyOption(f(*m.value)) } else { return NoneAny } }
func (m BoolOption) MapTuple2(f func(bool) Tuple2) Tuple2Option {
  if m.IsDefined() { return MkTuple2Option(f(*m.value)) } else { return NoneTuple2 } }
func (m BoolOption) MapBoolOption(f func(bool) BoolOption) BoolOptionOption {
  if m.IsDefined() { return MkBoolOptionOption(f(*m.value)) } else { return NoneBoolOption } }
func (m BoolOption) MapStringOption(f func(bool) StringOption) StringOptionOption {
  if m.IsDefined() { return MkStringOptionOption(f(*m.value)) } else { return NoneStringOption } }
func (m BoolOption) MapIntOption(f func(bool) IntOption) IntOptionOption {
  if m.IsDefined() { return MkIntOptionOption(f(*m.value)) } else { return NoneIntOption } }
func (m BoolOption) MapInt64Option(f func(bool) Int64Option) Int64OptionOption {
  if m.IsDefined() { return MkInt64OptionOption(f(*m.value)) } else { return NoneInt64Option } }
func (m BoolOption) MapByteOption(f func(bool) ByteOption) ByteOptionOption {
  if m.IsDefined() { return MkByteOptionOption(f(*m.value)) } else { return NoneByteOption } }
func (m BoolOption) MapRuneOption(f func(bool) RuneOption) RuneOptionOption {
  if m.IsDefined() { return MkRuneOptionOption(f(*m.value)) } else { return NoneRuneOption } }
func (m BoolOption) MapFloat32Option(f func(bool) Float32Option) Float32OptionOption {
  if m.IsDefined() { return MkFloat32OptionOption(f(*m.value)) } else { return NoneFloat32Option } }
func (m BoolOption) MapFloat64Option(f func(bool) Float64Option) Float64OptionOption {
  if m.IsDefined() { return MkFloat64OptionOption(f(*m.value)) } else { return NoneFloat64Option } }
func (m BoolOption) MapAnyOption(f func(bool) AnyOption) AnyOptionOption {
  if m.IsDefined() { return MkAnyOptionOption(f(*m.value)) } else { return NoneAnyOption } }
func (m BoolOption) MapTuple2Option(f func(bool) Tuple2Option) Tuple2OptionOption {
  if m.IsDefined() { return MkTuple2OptionOption(f(*m.value)) } else { return NoneTuple2Option } }
func (m BoolOption) MapBoolArray(f func(bool) []bool) BoolArrayOption {
  if m.IsDefined() { return MkBoolArrayOption(f(*m.value)) } else { return NoneBoolArray } }
func (m BoolOption) MapStringArray(f func(bool) []string) StringArrayOption {
  if m.IsDefined() { return MkStringArrayOption(f(*m.value)) } else { return NoneStringArray } }
func (m BoolOption) MapIntArray(f func(bool) []int) IntArrayOption {
  if m.IsDefined() { return MkIntArrayOption(f(*m.value)) } else { return NoneIntArray } }
func (m BoolOption) MapInt64Array(f func(bool) []int64) Int64ArrayOption {
  if m.IsDefined() { return MkInt64ArrayOption(f(*m.value)) } else { return NoneInt64Array } }
func (m BoolOption) MapByteArray(f func(bool) []byte) ByteArrayOption {
  if m.IsDefined() { return MkByteArrayOption(f(*m.value)) } else { return NoneByteArray } }
func (m BoolOption) MapRuneArray(f func(bool) []rune) RuneArrayOption {
  if m.IsDefined() { return MkRuneArrayOption(f(*m.value)) } else { return NoneRuneArray } }
func (m BoolOption) MapFloat32Array(f func(bool) []float32) Float32ArrayOption {
  if m.IsDefined() { return MkFloat32ArrayOption(f(*m.value)) } else { return NoneFloat32Array } }
func (m BoolOption) MapFloat64Array(f func(bool) []float64) Float64ArrayOption {
  if m.IsDefined() { return MkFloat64ArrayOption(f(*m.value)) } else { return NoneFloat64Array } }
func (m BoolOption) MapAnyArray(f func(bool) []Any) AnyArrayOption {
  if m.IsDefined() { return MkAnyArrayOption(f(*m.value)) } else { return NoneAnyArray } }
func (m BoolOption) MapTuple2Array(f func(bool) []Tuple2) Tuple2ArrayOption {
  if m.IsDefined() { return MkTuple2ArrayOption(f(*m.value)) } else { return NoneTuple2Array } }
func (m BoolOption) MapBoolList(f func(bool) BoolList) BoolListOption {
  if m.IsDefined() { return MkBoolListOption(f(*m.value)) } else { return NoneBoolList } }
func (m BoolOption) MapStringList(f func(bool) StringList) StringListOption {
  if m.IsDefined() { return MkStringListOption(f(*m.value)) } else { return NoneStringList } }
func (m BoolOption) MapIntList(f func(bool) IntList) IntListOption {
  if m.IsDefined() { return MkIntListOption(f(*m.value)) } else { return NoneIntList } }
func (m BoolOption) MapInt64List(f func(bool) Int64List) Int64ListOption {
  if m.IsDefined() { return MkInt64ListOption(f(*m.value)) } else { return NoneInt64List } }
func (m BoolOption) MapByteList(f func(bool) ByteList) ByteListOption {
  if m.IsDefined() { return MkByteListOption(f(*m.value)) } else { return NoneByteList } }
func (m BoolOption) MapRuneList(f func(bool) RuneList) RuneListOption {
  if m.IsDefined() { return MkRuneListOption(f(*m.value)) } else { return NoneRuneList } }
func (m BoolOption) MapFloat32List(f func(bool) Float32List) Float32ListOption {
  if m.IsDefined() { return MkFloat32ListOption(f(*m.value)) } else { return NoneFloat32List } }
func (m BoolOption) MapFloat64List(f func(bool) Float64List) Float64ListOption {
  if m.IsDefined() { return MkFloat64ListOption(f(*m.value)) } else { return NoneFloat64List } }
func (m BoolOption) MapAnyList(f func(bool) AnyList) AnyListOption {
  if m.IsDefined() { return MkAnyListOption(f(*m.value)) } else { return NoneAnyList } }
func (m BoolOption) MapTuple2List(f func(bool) Tuple2List) Tuple2ListOption {
  if m.IsDefined() { return MkTuple2ListOption(f(*m.value)) } else { return NoneTuple2List } }
