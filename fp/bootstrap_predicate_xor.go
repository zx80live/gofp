...
func (p1 BoolOptionListListPredicate) Xor(p2 BoolOptionListListPredicate) BoolOptionListListPredicate {
	return func(e BoolOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 StringOptionListListPredicate) Xor(p2 StringOptionListListPredicate) StringOptionListListPredicate {
	return func(e StringOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 IntOptionListListPredicate) Xor(p2 IntOptionListListPredicate) IntOptionListListPredicate {
	return func(e IntOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int8OptionListListPredicate) Xor(p2 Int8OptionListListPredicate) Int8OptionListListPredicate {
	return func(e Int8OptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int16OptionListListPredicate) Xor(p2 Int16OptionListListPredicate) Int16OptionListListPredicate {
	return func(e Int16OptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int32OptionListListPredicate) Xor(p2 Int32OptionListListPredicate) Int32OptionListListPredicate {
	return func(e Int32OptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int64OptionListListPredicate) Xor(p2 Int64OptionListListPredicate) Int64OptionListListPredicate {
	return func(e Int64OptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 UintOptionListListPredicate) Xor(p2 UintOptionListListPredicate) UintOptionListListPredicate {
	return func(e UintOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint8OptionListListPredicate) Xor(p2 Uint8OptionListListPredicate) Uint8OptionListListPredicate {
	return func(e Uint8OptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint16OptionListListPredicate) Xor(p2 Uint16OptionListListPredicate) Uint16OptionListListPredicate {
	return func(e Uint16OptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint32OptionListListPredicate) Xor(p2 Uint32OptionListListPredicate) Uint32OptionListListPredicate {
	return func(e Uint32OptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint64OptionListListPredicate) Xor(p2 Uint64OptionListListPredicate) Uint64OptionListListPredicate {
	return func(e Uint64OptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 UintptrOptionListListPredicate) Xor(p2 UintptrOptionListListPredicate) UintptrOptionListListPredicate {
	return func(e UintptrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 ByteOptionListListPredicate) Xor(p2 ByteOptionListListPredicate) ByteOptionListListPredicate {
	return func(e ByteOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 RuneOptionListListPredicate) Xor(p2 RuneOptionListListPredicate) RuneOptionListListPredicate {
	return func(e RuneOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Float32OptionListListPredicate) Xor(p2 Float32OptionListListPredicate) Float32OptionListListPredicate {
	return func(e Float32OptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Float64OptionListListPredicate) Xor(p2 Float64OptionListListPredicate) Float64OptionListListPredicate {
	return func(e Float64OptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Complex64OptionListListPredicate) Xor(p2 Complex64OptionListListPredicate) Complex64OptionListListPredicate {
	return func(e Complex64OptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Complex128OptionListListPredicate) Xor(p2 Complex128OptionListListPredicate) Complex128OptionListListPredicate {
	return func(e Complex128OptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 AnyOptionListListPredicate) Xor(p2 AnyOptionListListPredicate) AnyOptionListListPredicate {
	return func(e AnyOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 BoolArrOptionListListPredicate) Xor(p2 BoolArrOptionListListPredicate) BoolArrOptionListListPredicate {
	return func(e BoolArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 StringArrOptionListListPredicate) Xor(p2 StringArrOptionListListPredicate) StringArrOptionListListPredicate {
	return func(e StringArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 IntArrOptionListListPredicate) Xor(p2 IntArrOptionListListPredicate) IntArrOptionListListPredicate {
	return func(e IntArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int8ArrOptionListListPredicate) Xor(p2 Int8ArrOptionListListPredicate) Int8ArrOptionListListPredicate {
	return func(e Int8ArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int16ArrOptionListListPredicate) Xor(p2 Int16ArrOptionListListPredicate) Int16ArrOptionListListPredicate {
	return func(e Int16ArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int32ArrOptionListListPredicate) Xor(p2 Int32ArrOptionListListPredicate) Int32ArrOptionListListPredicate {
	return func(e Int32ArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int64ArrOptionListListPredicate) Xor(p2 Int64ArrOptionListListPredicate) Int64ArrOptionListListPredicate {
	return func(e Int64ArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 UintArrOptionListListPredicate) Xor(p2 UintArrOptionListListPredicate) UintArrOptionListListPredicate {
	return func(e UintArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint8ArrOptionListListPredicate) Xor(p2 Uint8ArrOptionListListPredicate) Uint8ArrOptionListListPredicate {
	return func(e Uint8ArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint16ArrOptionListListPredicate) Xor(p2 Uint16ArrOptionListListPredicate) Uint16ArrOptionListListPredicate {
	return func(e Uint16ArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint32ArrOptionListListPredicate) Xor(p2 Uint32ArrOptionListListPredicate) Uint32ArrOptionListListPredicate {
	return func(e Uint32ArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint64ArrOptionListListPredicate) Xor(p2 Uint64ArrOptionListListPredicate) Uint64ArrOptionListListPredicate {
	return func(e Uint64ArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 UintptrArrOptionListListPredicate) Xor(p2 UintptrArrOptionListListPredicate) UintptrArrOptionListListPredicate {
	return func(e UintptrArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 ByteArrOptionListListPredicate) Xor(p2 ByteArrOptionListListPredicate) ByteArrOptionListListPredicate {
	return func(e ByteArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 RuneArrOptionListListPredicate) Xor(p2 RuneArrOptionListListPredicate) RuneArrOptionListListPredicate {
	return func(e RuneArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Float32ArrOptionListListPredicate) Xor(p2 Float32ArrOptionListListPredicate) Float32ArrOptionListListPredicate {
	return func(e Float32ArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Float64ArrOptionListListPredicate) Xor(p2 Float64ArrOptionListListPredicate) Float64ArrOptionListListPredicate {
	return func(e Float64ArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Complex64ArrOptionListListPredicate) Xor(p2 Complex64ArrOptionListListPredicate) Complex64ArrOptionListListPredicate {
	return func(e Complex64ArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Complex128ArrOptionListListPredicate) Xor(p2 Complex128ArrOptionListListPredicate) Complex128ArrOptionListListPredicate {
	return func(e Complex128ArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 AnyArrOptionListListPredicate) Xor(p2 AnyArrOptionListListPredicate) AnyArrOptionListListPredicate {
	return func(e AnyArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 BoolArrArrOptionListListPredicate) Xor(p2 BoolArrArrOptionListListPredicate) BoolArrArrOptionListListPredicate {
	return func(e BoolArrArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 StringArrArrOptionListListPredicate) Xor(p2 StringArrArrOptionListListPredicate) StringArrArrOptionListListPredicate {
	return func(e StringArrArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 IntArrArrOptionListListPredicate) Xor(p2 IntArrArrOptionListListPredicate) IntArrArrOptionListListPredicate {
	return func(e IntArrArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int8ArrArrOptionListListPredicate) Xor(p2 Int8ArrArrOptionListListPredicate) Int8ArrArrOptionListListPredicate {
	return func(e Int8ArrArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int16ArrArrOptionListListPredicate) Xor(p2 Int16ArrArrOptionListListPredicate) Int16ArrArrOptionListListPredicate {
	return func(e Int16ArrArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int32ArrArrOptionListListPredicate) Xor(p2 Int32ArrArrOptionListListPredicate) Int32ArrArrOptionListListPredicate {
	return func(e Int32ArrArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int64ArrArrOptionListListPredicate) Xor(p2 Int64ArrArrOptionListListPredicate) Int64ArrArrOptionListListPredicate {
	return func(e Int64ArrArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 UintArrArrOptionListListPredicate) Xor(p2 UintArrArrOptionListListPredicate) UintArrArrOptionListListPredicate {
	return func(e UintArrArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint8ArrArrOptionListListPredicate) Xor(p2 Uint8ArrArrOptionListListPredicate) Uint8ArrArrOptionListListPredicate {
	return func(e Uint8ArrArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint16ArrArrOptionListListPredicate) Xor(p2 Uint16ArrArrOptionListListPredicate) Uint16ArrArrOptionListListPredicate {
	return func(e Uint16ArrArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint32ArrArrOptionListListPredicate) Xor(p2 Uint32ArrArrOptionListListPredicate) Uint32ArrArrOptionListListPredicate {
	return func(e Uint32ArrArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint64ArrArrOptionListListPredicate) Xor(p2 Uint64ArrArrOptionListListPredicate) Uint64ArrArrOptionListListPredicate {
	return func(e Uint64ArrArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 UintptrArrArrOptionListListPredicate) Xor(p2 UintptrArrArrOptionListListPredicate) UintptrArrArrOptionListListPredicate {
	return func(e UintptrArrArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 ByteArrArrOptionListListPredicate) Xor(p2 ByteArrArrOptionListListPredicate) ByteArrArrOptionListListPredicate {
	return func(e ByteArrArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 RuneArrArrOptionListListPredicate) Xor(p2 RuneArrArrOptionListListPredicate) RuneArrArrOptionListListPredicate {
	return func(e RuneArrArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Float32ArrArrOptionListListPredicate) Xor(p2 Float32ArrArrOptionListListPredicate) Float32ArrArrOptionListListPredicate {
	return func(e Float32ArrArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Float64ArrArrOptionListListPredicate) Xor(p2 Float64ArrArrOptionListListPredicate) Float64ArrArrOptionListListPredicate {
	return func(e Float64ArrArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Complex64ArrArrOptionListListPredicate) Xor(p2 Complex64ArrArrOptionListListPredicate) Complex64ArrArrOptionListListPredicate {
	return func(e Complex64ArrArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Complex128ArrArrOptionListListPredicate) Xor(p2 Complex128ArrArrOptionListListPredicate) Complex128ArrArrOptionListListPredicate {
	return func(e Complex128ArrArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 AnyArrArrOptionListListPredicate) Xor(p2 AnyArrArrOptionListListPredicate) AnyArrArrOptionListListPredicate {
	return func(e AnyArrArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 BoolOptionArrOptionListListPredicate) Xor(p2 BoolOptionArrOptionListListPredicate) BoolOptionArrOptionListListPredicate {
	return func(e BoolOptionArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 StringOptionArrOptionListListPredicate) Xor(p2 StringOptionArrOptionListListPredicate) StringOptionArrOptionListListPredicate {
	return func(e StringOptionArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 IntOptionArrOptionListListPredicate) Xor(p2 IntOptionArrOptionListListPredicate) IntOptionArrOptionListListPredicate {
	return func(e IntOptionArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int8OptionArrOptionListListPredicate) Xor(p2 Int8OptionArrOptionListListPredicate) Int8OptionArrOptionListListPredicate {
	return func(e Int8OptionArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int16OptionArrOptionListListPredicate) Xor(p2 Int16OptionArrOptionListListPredicate) Int16OptionArrOptionListListPredicate {
	return func(e Int16OptionArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int32OptionArrOptionListListPredicate) Xor(p2 Int32OptionArrOptionListListPredicate) Int32OptionArrOptionListListPredicate {
	return func(e Int32OptionArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int64OptionArrOptionListListPredicate) Xor(p2 Int64OptionArrOptionListListPredicate) Int64OptionArrOptionListListPredicate {
	return func(e Int64OptionArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 UintOptionArrOptionListListPredicate) Xor(p2 UintOptionArrOptionListListPredicate) UintOptionArrOptionListListPredicate {
	return func(e UintOptionArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint8OptionArrOptionListListPredicate) Xor(p2 Uint8OptionArrOptionListListPredicate) Uint8OptionArrOptionListListPredicate {
	return func(e Uint8OptionArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint16OptionArrOptionListListPredicate) Xor(p2 Uint16OptionArrOptionListListPredicate) Uint16OptionArrOptionListListPredicate {
	return func(e Uint16OptionArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint32OptionArrOptionListListPredicate) Xor(p2 Uint32OptionArrOptionListListPredicate) Uint32OptionArrOptionListListPredicate {
	return func(e Uint32OptionArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint64OptionArrOptionListListPredicate) Xor(p2 Uint64OptionArrOptionListListPredicate) Uint64OptionArrOptionListListPredicate {
	return func(e Uint64OptionArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 UintptrOptionArrOptionListListPredicate) Xor(p2 UintptrOptionArrOptionListListPredicate) UintptrOptionArrOptionListListPredicate {
	return func(e UintptrOptionArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 ByteOptionArrOptionListListPredicate) Xor(p2 ByteOptionArrOptionListListPredicate) ByteOptionArrOptionListListPredicate {
	return func(e ByteOptionArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 RuneOptionArrOptionListListPredicate) Xor(p2 RuneOptionArrOptionListListPredicate) RuneOptionArrOptionListListPredicate {
	return func(e RuneOptionArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Float32OptionArrOptionListListPredicate) Xor(p2 Float32OptionArrOptionListListPredicate) Float32OptionArrOptionListListPredicate {
	return func(e Float32OptionArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Float64OptionArrOptionListListPredicate) Xor(p2 Float64OptionArrOptionListListPredicate) Float64OptionArrOptionListListPredicate {
	return func(e Float64OptionArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Complex64OptionArrOptionListListPredicate) Xor(p2 Complex64OptionArrOptionListListPredicate) Complex64OptionArrOptionListListPredicate {
	return func(e Complex64OptionArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Complex128OptionArrOptionListListPredicate) Xor(p2 Complex128OptionArrOptionListListPredicate) Complex128OptionArrOptionListListPredicate {
	return func(e Complex128OptionArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 AnyOptionArrOptionListListPredicate) Xor(p2 AnyOptionArrOptionListListPredicate) AnyOptionArrOptionListListPredicate {
	return func(e AnyOptionArrOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 BoolListOptionListListPredicate) Xor(p2 BoolListOptionListListPredicate) BoolListOptionListListPredicate {
	return func(e BoolListOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 StringListOptionListListPredicate) Xor(p2 StringListOptionListListPredicate) StringListOptionListListPredicate {
	return func(e StringListOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 IntListOptionListListPredicate) Xor(p2 IntListOptionListListPredicate) IntListOptionListListPredicate {
	return func(e IntListOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int8ListOptionListListPredicate) Xor(p2 Int8ListOptionListListPredicate) Int8ListOptionListListPredicate {
	return func(e Int8ListOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int16ListOptionListListPredicate) Xor(p2 Int16ListOptionListListPredicate) Int16ListOptionListListPredicate {
	return func(e Int16ListOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int32ListOptionListListPredicate) Xor(p2 Int32ListOptionListListPredicate) Int32ListOptionListListPredicate {
	return func(e Int32ListOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int64ListOptionListListPredicate) Xor(p2 Int64ListOptionListListPredicate) Int64ListOptionListListPredicate {
	return func(e Int64ListOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 UintListOptionListListPredicate) Xor(p2 UintListOptionListListPredicate) UintListOptionListListPredicate {
	return func(e UintListOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint8ListOptionListListPredicate) Xor(p2 Uint8ListOptionListListPredicate) Uint8ListOptionListListPredicate {
	return func(e Uint8ListOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint16ListOptionListListPredicate) Xor(p2 Uint16ListOptionListListPredicate) Uint16ListOptionListListPredicate {
	return func(e Uint16ListOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint32ListOptionListListPredicate) Xor(p2 Uint32ListOptionListListPredicate) Uint32ListOptionListListPredicate {
	return func(e Uint32ListOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint64ListOptionListListPredicate) Xor(p2 Uint64ListOptionListListPredicate) Uint64ListOptionListListPredicate {
	return func(e Uint64ListOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 UintptrListOptionListListPredicate) Xor(p2 UintptrListOptionListListPredicate) UintptrListOptionListListPredicate {
	return func(e UintptrListOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 ByteListOptionListListPredicate) Xor(p2 ByteListOptionListListPredicate) ByteListOptionListListPredicate {
	return func(e ByteListOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 RuneListOptionListListPredicate) Xor(p2 RuneListOptionListListPredicate) RuneListOptionListListPredicate {
	return func(e RuneListOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Float32ListOptionListListPredicate) Xor(p2 Float32ListOptionListListPredicate) Float32ListOptionListListPredicate {
	return func(e Float32ListOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Float64ListOptionListListPredicate) Xor(p2 Float64ListOptionListListPredicate) Float64ListOptionListListPredicate {
	return func(e Float64ListOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Complex64ListOptionListListPredicate) Xor(p2 Complex64ListOptionListListPredicate) Complex64ListOptionListListPredicate {
	return func(e Complex64ListOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Complex128ListOptionListListPredicate) Xor(p2 Complex128ListOptionListListPredicate) Complex128ListOptionListListPredicate {
	return func(e Complex128ListOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 AnyListOptionListListPredicate) Xor(p2 AnyListOptionListListPredicate) AnyListOptionListListPredicate {
	return func(e AnyListOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 BoolOptionOptionListListPredicate) Xor(p2 BoolOptionOptionListListPredicate) BoolOptionOptionListListPredicate {
	return func(e BoolOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 StringOptionOptionListListPredicate) Xor(p2 StringOptionOptionListListPredicate) StringOptionOptionListListPredicate {
	return func(e StringOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 IntOptionOptionListListPredicate) Xor(p2 IntOptionOptionListListPredicate) IntOptionOptionListListPredicate {
	return func(e IntOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int8OptionOptionListListPredicate) Xor(p2 Int8OptionOptionListListPredicate) Int8OptionOptionListListPredicate {
	return func(e Int8OptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int16OptionOptionListListPredicate) Xor(p2 Int16OptionOptionListListPredicate) Int16OptionOptionListListPredicate {
	return func(e Int16OptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int32OptionOptionListListPredicate) Xor(p2 Int32OptionOptionListListPredicate) Int32OptionOptionListListPredicate {
	return func(e Int32OptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int64OptionOptionListListPredicate) Xor(p2 Int64OptionOptionListListPredicate) Int64OptionOptionListListPredicate {
	return func(e Int64OptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 UintOptionOptionListListPredicate) Xor(p2 UintOptionOptionListListPredicate) UintOptionOptionListListPredicate {
	return func(e UintOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint8OptionOptionListListPredicate) Xor(p2 Uint8OptionOptionListListPredicate) Uint8OptionOptionListListPredicate {
	return func(e Uint8OptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint16OptionOptionListListPredicate) Xor(p2 Uint16OptionOptionListListPredicate) Uint16OptionOptionListListPredicate {
	return func(e Uint16OptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint32OptionOptionListListPredicate) Xor(p2 Uint32OptionOptionListListPredicate) Uint32OptionOptionListListPredicate {
	return func(e Uint32OptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint64OptionOptionListListPredicate) Xor(p2 Uint64OptionOptionListListPredicate) Uint64OptionOptionListListPredicate {
	return func(e Uint64OptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 UintptrOptionOptionListListPredicate) Xor(p2 UintptrOptionOptionListListPredicate) UintptrOptionOptionListListPredicate {
	return func(e UintptrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 ByteOptionOptionListListPredicate) Xor(p2 ByteOptionOptionListListPredicate) ByteOptionOptionListListPredicate {
	return func(e ByteOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 RuneOptionOptionListListPredicate) Xor(p2 RuneOptionOptionListListPredicate) RuneOptionOptionListListPredicate {
	return func(e RuneOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Float32OptionOptionListListPredicate) Xor(p2 Float32OptionOptionListListPredicate) Float32OptionOptionListListPredicate {
	return func(e Float32OptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Float64OptionOptionListListPredicate) Xor(p2 Float64OptionOptionListListPredicate) Float64OptionOptionListListPredicate {
	return func(e Float64OptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Complex64OptionOptionListListPredicate) Xor(p2 Complex64OptionOptionListListPredicate) Complex64OptionOptionListListPredicate {
	return func(e Complex64OptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Complex128OptionOptionListListPredicate) Xor(p2 Complex128OptionOptionListListPredicate) Complex128OptionOptionListListPredicate {
	return func(e Complex128OptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 AnyOptionOptionListListPredicate) Xor(p2 AnyOptionOptionListListPredicate) AnyOptionOptionListListPredicate {
	return func(e AnyOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 BoolArrOptionOptionListListPredicate) Xor(p2 BoolArrOptionOptionListListPredicate) BoolArrOptionOptionListListPredicate {
	return func(e BoolArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 StringArrOptionOptionListListPredicate) Xor(p2 StringArrOptionOptionListListPredicate) StringArrOptionOptionListListPredicate {
	return func(e StringArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 IntArrOptionOptionListListPredicate) Xor(p2 IntArrOptionOptionListListPredicate) IntArrOptionOptionListListPredicate {
	return func(e IntArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int8ArrOptionOptionListListPredicate) Xor(p2 Int8ArrOptionOptionListListPredicate) Int8ArrOptionOptionListListPredicate {
	return func(e Int8ArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int16ArrOptionOptionListListPredicate) Xor(p2 Int16ArrOptionOptionListListPredicate) Int16ArrOptionOptionListListPredicate {
	return func(e Int16ArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int32ArrOptionOptionListListPredicate) Xor(p2 Int32ArrOptionOptionListListPredicate) Int32ArrOptionOptionListListPredicate {
	return func(e Int32ArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int64ArrOptionOptionListListPredicate) Xor(p2 Int64ArrOptionOptionListListPredicate) Int64ArrOptionOptionListListPredicate {
	return func(e Int64ArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 UintArrOptionOptionListListPredicate) Xor(p2 UintArrOptionOptionListListPredicate) UintArrOptionOptionListListPredicate {
	return func(e UintArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint8ArrOptionOptionListListPredicate) Xor(p2 Uint8ArrOptionOptionListListPredicate) Uint8ArrOptionOptionListListPredicate {
	return func(e Uint8ArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint16ArrOptionOptionListListPredicate) Xor(p2 Uint16ArrOptionOptionListListPredicate) Uint16ArrOptionOptionListListPredicate {
	return func(e Uint16ArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint32ArrOptionOptionListListPredicate) Xor(p2 Uint32ArrOptionOptionListListPredicate) Uint32ArrOptionOptionListListPredicate {
	return func(e Uint32ArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint64ArrOptionOptionListListPredicate) Xor(p2 Uint64ArrOptionOptionListListPredicate) Uint64ArrOptionOptionListListPredicate {
	return func(e Uint64ArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 UintptrArrOptionOptionListListPredicate) Xor(p2 UintptrArrOptionOptionListListPredicate) UintptrArrOptionOptionListListPredicate {
	return func(e UintptrArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 ByteArrOptionOptionListListPredicate) Xor(p2 ByteArrOptionOptionListListPredicate) ByteArrOptionOptionListListPredicate {
	return func(e ByteArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 RuneArrOptionOptionListListPredicate) Xor(p2 RuneArrOptionOptionListListPredicate) RuneArrOptionOptionListListPredicate {
	return func(e RuneArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Float32ArrOptionOptionListListPredicate) Xor(p2 Float32ArrOptionOptionListListPredicate) Float32ArrOptionOptionListListPredicate {
	return func(e Float32ArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Float64ArrOptionOptionListListPredicate) Xor(p2 Float64ArrOptionOptionListListPredicate) Float64ArrOptionOptionListListPredicate {
	return func(e Float64ArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Complex64ArrOptionOptionListListPredicate) Xor(p2 Complex64ArrOptionOptionListListPredicate) Complex64ArrOptionOptionListListPredicate {
	return func(e Complex64ArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Complex128ArrOptionOptionListListPredicate) Xor(p2 Complex128ArrOptionOptionListListPredicate) Complex128ArrOptionOptionListListPredicate {
	return func(e Complex128ArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 AnyArrOptionOptionListListPredicate) Xor(p2 AnyArrOptionOptionListListPredicate) AnyArrOptionOptionListListPredicate {
	return func(e AnyArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 BoolArrArrOptionOptionListListPredicate) Xor(p2 BoolArrArrOptionOptionListListPredicate) BoolArrArrOptionOptionListListPredicate {
	return func(e BoolArrArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 StringArrArrOptionOptionListListPredicate) Xor(p2 StringArrArrOptionOptionListListPredicate) StringArrArrOptionOptionListListPredicate {
	return func(e StringArrArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 IntArrArrOptionOptionListListPredicate) Xor(p2 IntArrArrOptionOptionListListPredicate) IntArrArrOptionOptionListListPredicate {
	return func(e IntArrArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int8ArrArrOptionOptionListListPredicate) Xor(p2 Int8ArrArrOptionOptionListListPredicate) Int8ArrArrOptionOptionListListPredicate {
	return func(e Int8ArrArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int16ArrArrOptionOptionListListPredicate) Xor(p2 Int16ArrArrOptionOptionListListPredicate) Int16ArrArrOptionOptionListListPredicate {
	return func(e Int16ArrArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int32ArrArrOptionOptionListListPredicate) Xor(p2 Int32ArrArrOptionOptionListListPredicate) Int32ArrArrOptionOptionListListPredicate {
	return func(e Int32ArrArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int64ArrArrOptionOptionListListPredicate) Xor(p2 Int64ArrArrOptionOptionListListPredicate) Int64ArrArrOptionOptionListListPredicate {
	return func(e Int64ArrArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 UintArrArrOptionOptionListListPredicate) Xor(p2 UintArrArrOptionOptionListListPredicate) UintArrArrOptionOptionListListPredicate {
	return func(e UintArrArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint8ArrArrOptionOptionListListPredicate) Xor(p2 Uint8ArrArrOptionOptionListListPredicate) Uint8ArrArrOptionOptionListListPredicate {
	return func(e Uint8ArrArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint16ArrArrOptionOptionListListPredicate) Xor(p2 Uint16ArrArrOptionOptionListListPredicate) Uint16ArrArrOptionOptionListListPredicate {
	return func(e Uint16ArrArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint32ArrArrOptionOptionListListPredicate) Xor(p2 Uint32ArrArrOptionOptionListListPredicate) Uint32ArrArrOptionOptionListListPredicate {
	return func(e Uint32ArrArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint64ArrArrOptionOptionListListPredicate) Xor(p2 Uint64ArrArrOptionOptionListListPredicate) Uint64ArrArrOptionOptionListListPredicate {
	return func(e Uint64ArrArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 UintptrArrArrOptionOptionListListPredicate) Xor(p2 UintptrArrArrOptionOptionListListPredicate) UintptrArrArrOptionOptionListListPredicate {
	return func(e UintptrArrArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 ByteArrArrOptionOptionListListPredicate) Xor(p2 ByteArrArrOptionOptionListListPredicate) ByteArrArrOptionOptionListListPredicate {
	return func(e ByteArrArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 RuneArrArrOptionOptionListListPredicate) Xor(p2 RuneArrArrOptionOptionListListPredicate) RuneArrArrOptionOptionListListPredicate {
	return func(e RuneArrArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Float32ArrArrOptionOptionListListPredicate) Xor(p2 Float32ArrArrOptionOptionListListPredicate) Float32ArrArrOptionOptionListListPredicate {
	return func(e Float32ArrArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Float64ArrArrOptionOptionListListPredicate) Xor(p2 Float64ArrArrOptionOptionListListPredicate) Float64ArrArrOptionOptionListListPredicate {
	return func(e Float64ArrArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Complex64ArrArrOptionOptionListListPredicate) Xor(p2 Complex64ArrArrOptionOptionListListPredicate) Complex64ArrArrOptionOptionListListPredicate {
	return func(e Complex64ArrArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Complex128ArrArrOptionOptionListListPredicate) Xor(p2 Complex128ArrArrOptionOptionListListPredicate) Complex128ArrArrOptionOptionListListPredicate {
	return func(e Complex128ArrArrOptionOptionListList) bool {
		x := p1(e)
		y := p2(e)
		return (x || y) && !(x && y)
	}
}
func (p1 AnyArrArrOptionOptionListListPredicate) Xor(p2 AnyArrArrOptionOptionListListPredicate) AnyArrArrOptionOptionListListPredicate {
	return func(e AnyArrArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 BoolOptionArrOptionOptionListListPredicate) Xor(p2 BoolOptionArrOptionOptionListListPredicate) BoolOptionArrOptionOptionListListPredicate {
	return func(e BoolOptionArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 StringOptionArrOptionOptionListListPredicate) Xor(p2 StringOptionArrOptionOptionListListPredicate) StringOptionArrOptionOptionListListPredicate {
	return func(e StringOptionArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 IntOptionArrOptionOptionListListPredicate) Xor(p2 IntOptionArrOptionOptionListListPredicate) IntOptionArrOptionOptionListListPredicate {
	return func(e IntOptionArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int8OptionArrOptionOptionListListPredicate) Xor(p2 Int8OptionArrOptionOptionListListPredicate) Int8OptionArrOptionOptionListListPredicate {
	return func(e Int8OptionArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int16OptionArrOptionOptionListListPredicate) Xor(p2 Int16OptionArrOptionOptionListListPredicate) Int16OptionArrOptionOptionListListPredicate {
	return func(e Int16OptionArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int32OptionArrOptionOptionListListPredicate) Xor(p2 Int32OptionArrOptionOptionListListPredicate) Int32OptionArrOptionOptionListListPredicate {
	return func(e Int32OptionArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int64OptionArrOptionOptionListListPredicate) Xor(p2 Int64OptionArrOptionOptionListListPredicate) Int64OptionArrOptionOptionListListPredicate {
	return func(e Int64OptionArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 UintOptionArrOptionOptionListListPredicate) Xor(p2 UintOptionArrOptionOptionListListPredicate) UintOptionArrOptionOptionListListPredicate {
	return func(e UintOptionArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint8OptionArrOptionOptionListListPredicate) Xor(p2 Uint8OptionArrOptionOptionListListPredicate) Uint8OptionArrOptionOptionListListPredicate {
	return func(e Uint8OptionArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint16OptionArrOptionOptionListListPredicate) Xor(p2 Uint16OptionArrOptionOptionListListPredicate) Uint16OptionArrOptionOptionListListPredicate {
	return func(e Uint16OptionArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint32OptionArrOptionOptionListListPredicate) Xor(p2 Uint32OptionArrOptionOptionListListPredicate) Uint32OptionArrOptionOptionListListPredicate {
	return func(e Uint32OptionArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint64OptionArrOptionOptionListListPredicate) Xor(p2 Uint64OptionArrOptionOptionListListPredicate) Uint64OptionArrOptionOptionListListPredicate {
	return func(e Uint64OptionArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 UintptrOptionArrOptionOptionListListPredicate) Xor(p2 UintptrOptionArrOptionOptionListListPredicate) UintptrOptionArrOptionOptionListListPredicate {
	return func(e UintptrOptionArrOptionOptionListList) bool {
		x := p1(e)
		y := p2(e)
		return (x || y) && !(x && y)
	}
}
func (p1 ByteOptionArrOptionOptionListListPredicate) Xor(p2 ByteOptionArrOptionOptionListListPredicate) ByteOptionArrOptionOptionListListPredicate {
	return func(e ByteOptionArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 RuneOptionArrOptionOptionListListPredicate) Xor(p2 RuneOptionArrOptionOptionListListPredicate) RuneOptionArrOptionOptionListListPredicate {
	return func(e RuneOptionArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Float32OptionArrOptionOptionListListPredicate) Xor(p2 Float32OptionArrOptionOptionListListPredicate) Float32OptionArrOptionOptionListListPredicate {
	return func(e Float32OptionArrOptionOptionListList) bool {
		x := p1(e)
		y := p2(e)
		return (x || y) && !(x && y)
	}
}
func (p1 Float64OptionArrOptionOptionListListPredicate) Xor(p2 Float64OptionArrOptionOptionListListPredicate) Float64OptionArrOptionOptionListListPredicate {
	return func(e Float64OptionArrOptionOptionListList) bool {
		x := p1(e)
		y := p2(e)
		return (x || y) && !(x && y)
	}
}
func (p1 Complex64OptionArrOptionOptionListListPredicate) Xor(p2 Complex64OptionArrOptionOptionListListPredicate) Complex64OptionArrOptionOptionListListPredicate {
	return func(e Complex64OptionArrOptionOptionListList) bool {
		x := p1(e)
		y := p2(e)
		return (x || y) && !(x && y)
	}
}
func (p1 Complex128OptionArrOptionOptionListListPredicate) Xor(p2 Complex128OptionArrOptionOptionListListPredicate) Complex128OptionArrOptionOptionListListPredicate {
	return func(e Complex128OptionArrOptionOptionListList) bool {
		x := p1(e)
		y := p2(e)
		return (x || y) && !(x && y)
	}
}
func (p1 AnyOptionArrOptionOptionListListPredicate) Xor(p2 AnyOptionArrOptionOptionListListPredicate) AnyOptionArrOptionOptionListListPredicate {
	return func(e AnyOptionArrOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 BoolListOptionOptionListListPredicate) Xor(p2 BoolListOptionOptionListListPredicate) BoolListOptionOptionListListPredicate {
	return func(e BoolListOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 StringListOptionOptionListListPredicate) Xor(p2 StringListOptionOptionListListPredicate) StringListOptionOptionListListPredicate {
	return func(e StringListOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 IntListOptionOptionListListPredicate) Xor(p2 IntListOptionOptionListListPredicate) IntListOptionOptionListListPredicate {
	return func(e IntListOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int8ListOptionOptionListListPredicate) Xor(p2 Int8ListOptionOptionListListPredicate) Int8ListOptionOptionListListPredicate {
	return func(e Int8ListOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int16ListOptionOptionListListPredicate) Xor(p2 Int16ListOptionOptionListListPredicate) Int16ListOptionOptionListListPredicate {
	return func(e Int16ListOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int32ListOptionOptionListListPredicate) Xor(p2 Int32ListOptionOptionListListPredicate) Int32ListOptionOptionListListPredicate {
	return func(e Int32ListOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int64ListOptionOptionListListPredicate) Xor(p2 Int64ListOptionOptionListListPredicate) Int64ListOptionOptionListListPredicate {
	return func(e Int64ListOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 UintListOptionOptionListListPredicate) Xor(p2 UintListOptionOptionListListPredicate) UintListOptionOptionListListPredicate {
	return func(e UintListOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint8ListOptionOptionListListPredicate) Xor(p2 Uint8ListOptionOptionListListPredicate) Uint8ListOptionOptionListListPredicate {
	return func(e Uint8ListOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint16ListOptionOptionListListPredicate) Xor(p2 Uint16ListOptionOptionListListPredicate) Uint16ListOptionOptionListListPredicate {
	return func(e Uint16ListOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint32ListOptionOptionListListPredicate) Xor(p2 Uint32ListOptionOptionListListPredicate) Uint32ListOptionOptionListListPredicate {
	return func(e Uint32ListOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint64ListOptionOptionListListPredicate) Xor(p2 Uint64ListOptionOptionListListPredicate) Uint64ListOptionOptionListListPredicate {
	return func(e Uint64ListOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 UintptrListOptionOptionListListPredicate) Xor(p2 UintptrListOptionOptionListListPredicate) UintptrListOptionOptionListListPredicate {
	return func(e UintptrListOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 ByteListOptionOptionListListPredicate) Xor(p2 ByteListOptionOptionListListPredicate) ByteListOptionOptionListListPredicate {
	return func(e ByteListOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 RuneListOptionOptionListListPredicate) Xor(p2 RuneListOptionOptionListListPredicate) RuneListOptionOptionListListPredicate {
	return func(e RuneListOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Float32ListOptionOptionListListPredicate) Xor(p2 Float32ListOptionOptionListListPredicate) Float32ListOptionOptionListListPredicate {
	return func(e Float32ListOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Float64ListOptionOptionListListPredicate) Xor(p2 Float64ListOptionOptionListListPredicate) Float64ListOptionOptionListListPredicate {
	return func(e Float64ListOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Complex64ListOptionOptionListListPredicate) Xor(p2 Complex64ListOptionOptionListListPredicate) Complex64ListOptionOptionListListPredicate {
	return func(e Complex64ListOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Complex128ListOptionOptionListListPredicate) Xor(p2 Complex128ListOptionOptionListListPredicate) Complex128ListOptionOptionListListPredicate {
	return func(e Complex128ListOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 AnyListOptionOptionListListPredicate) Xor(p2 AnyListOptionOptionListListPredicate) AnyListOptionOptionListListPredicate {
	return func(e AnyListOptionOptionListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 BoolArrListListPredicate) Xor(p2 BoolArrListListPredicate) BoolArrListListPredicate {
	return func(e BoolArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 StringArrListListPredicate) Xor(p2 StringArrListListPredicate) StringArrListListPredicate {
	return func(e StringArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 IntArrListListPredicate) Xor(p2 IntArrListListPredicate) IntArrListListPredicate {
	return func(e IntArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int8ArrListListPredicate) Xor(p2 Int8ArrListListPredicate) Int8ArrListListPredicate {
	return func(e Int8ArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int16ArrListListPredicate) Xor(p2 Int16ArrListListPredicate) Int16ArrListListPredicate {
	return func(e Int16ArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int32ArrListListPredicate) Xor(p2 Int32ArrListListPredicate) Int32ArrListListPredicate {
	return func(e Int32ArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int64ArrListListPredicate) Xor(p2 Int64ArrListListPredicate) Int64ArrListListPredicate {
	return func(e Int64ArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 UintArrListListPredicate) Xor(p2 UintArrListListPredicate) UintArrListListPredicate {
	return func(e UintArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint8ArrListListPredicate) Xor(p2 Uint8ArrListListPredicate) Uint8ArrListListPredicate {
	return func(e Uint8ArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint16ArrListListPredicate) Xor(p2 Uint16ArrListListPredicate) Uint16ArrListListPredicate {
	return func(e Uint16ArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint32ArrListListPredicate) Xor(p2 Uint32ArrListListPredicate) Uint32ArrListListPredicate {
	return func(e Uint32ArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint64ArrListListPredicate) Xor(p2 Uint64ArrListListPredicate) Uint64ArrListListPredicate {
	return func(e Uint64ArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 UintptrArrListListPredicate) Xor(p2 UintptrArrListListPredicate) UintptrArrListListPredicate {
	return func(e UintptrArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 ByteArrListListPredicate) Xor(p2 ByteArrListListPredicate) ByteArrListListPredicate {
	return func(e ByteArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 RuneArrListListPredicate) Xor(p2 RuneArrListListPredicate) RuneArrListListPredicate {
	return func(e RuneArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Float32ArrListListPredicate) Xor(p2 Float32ArrListListPredicate) Float32ArrListListPredicate {
	return func(e Float32ArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Float64ArrListListPredicate) Xor(p2 Float64ArrListListPredicate) Float64ArrListListPredicate {
	return func(e Float64ArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Complex64ArrListListPredicate) Xor(p2 Complex64ArrListListPredicate) Complex64ArrListListPredicate {
	return func(e Complex64ArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Complex128ArrListListPredicate) Xor(p2 Complex128ArrListListPredicate) Complex128ArrListListPredicate {
	return func(e Complex128ArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 AnyArrListListPredicate) Xor(p2 AnyArrListListPredicate) AnyArrListListPredicate {
	return func(e AnyArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 BoolArrArrListListPredicate) Xor(p2 BoolArrArrListListPredicate) BoolArrArrListListPredicate {
	return func(e BoolArrArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 StringArrArrListListPredicate) Xor(p2 StringArrArrListListPredicate) StringArrArrListListPredicate {
	return func(e StringArrArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 IntArrArrListListPredicate) Xor(p2 IntArrArrListListPredicate) IntArrArrListListPredicate {
	return func(e IntArrArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int8ArrArrListListPredicate) Xor(p2 Int8ArrArrListListPredicate) Int8ArrArrListListPredicate {
	return func(e Int8ArrArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int16ArrArrListListPredicate) Xor(p2 Int16ArrArrListListPredicate) Int16ArrArrListListPredicate {
	return func(e Int16ArrArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int32ArrArrListListPredicate) Xor(p2 Int32ArrArrListListPredicate) Int32ArrArrListListPredicate {
	return func(e Int32ArrArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int64ArrArrListListPredicate) Xor(p2 Int64ArrArrListListPredicate) Int64ArrArrListListPredicate {
	return func(e Int64ArrArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 UintArrArrListListPredicate) Xor(p2 UintArrArrListListPredicate) UintArrArrListListPredicate {
	return func(e UintArrArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint8ArrArrListListPredicate) Xor(p2 Uint8ArrArrListListPredicate) Uint8ArrArrListListPredicate {
	return func(e Uint8ArrArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint16ArrArrListListPredicate) Xor(p2 Uint16ArrArrListListPredicate) Uint16ArrArrListListPredicate {
	return func(e Uint16ArrArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint32ArrArrListListPredicate) Xor(p2 Uint32ArrArrListListPredicate) Uint32ArrArrListListPredicate {
	return func(e Uint32ArrArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint64ArrArrListListPredicate) Xor(p2 Uint64ArrArrListListPredicate) Uint64ArrArrListListPredicate {
	return func(e Uint64ArrArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 UintptrArrArrListListPredicate) Xor(p2 UintptrArrArrListListPredicate) UintptrArrArrListListPredicate {
	return func(e UintptrArrArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 ByteArrArrListListPredicate) Xor(p2 ByteArrArrListListPredicate) ByteArrArrListListPredicate {
	return func(e ByteArrArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 RuneArrArrListListPredicate) Xor(p2 RuneArrArrListListPredicate) RuneArrArrListListPredicate {
	return func(e RuneArrArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Float32ArrArrListListPredicate) Xor(p2 Float32ArrArrListListPredicate) Float32ArrArrListListPredicate {
	return func(e Float32ArrArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Float64ArrArrListListPredicate) Xor(p2 Float64ArrArrListListPredicate) Float64ArrArrListListPredicate {
	return func(e Float64ArrArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Complex64ArrArrListListPredicate) Xor(p2 Complex64ArrArrListListPredicate) Complex64ArrArrListListPredicate {
	return func(e Complex64ArrArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Complex128ArrArrListListPredicate) Xor(p2 Complex128ArrArrListListPredicate) Complex128ArrArrListListPredicate {
	return func(e Complex128ArrArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 AnyArrArrListListPredicate) Xor(p2 AnyArrArrListListPredicate) AnyArrArrListListPredicate {
	return func(e AnyArrArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 BoolOptionArrListListPredicate) Xor(p2 BoolOptionArrListListPredicate) BoolOptionArrListListPredicate {
	return func(e BoolOptionArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 StringOptionArrListListPredicate) Xor(p2 StringOptionArrListListPredicate) StringOptionArrListListPredicate {
	return func(e StringOptionArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 IntOptionArrListListPredicate) Xor(p2 IntOptionArrListListPredicate) IntOptionArrListListPredicate {
	return func(e IntOptionArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int8OptionArrListListPredicate) Xor(p2 Int8OptionArrListListPredicate) Int8OptionArrListListPredicate {
	return func(e Int8OptionArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int16OptionArrListListPredicate) Xor(p2 Int16OptionArrListListPredicate) Int16OptionArrListListPredicate {
	return func(e Int16OptionArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int32OptionArrListListPredicate) Xor(p2 Int32OptionArrListListPredicate) Int32OptionArrListListPredicate {
	return func(e Int32OptionArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Int64OptionArrListListPredicate) Xor(p2 Int64OptionArrListListPredicate) Int64OptionArrListListPredicate {
	return func(e Int64OptionArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 UintOptionArrListListPredicate) Xor(p2 UintOptionArrListListPredicate) UintOptionArrListListPredicate {
	return func(e UintOptionArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint8OptionArrListListPredicate) Xor(p2 Uint8OptionArrListListPredicate) Uint8OptionArrListListPredicate {
	return func(e Uint8OptionArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint16OptionArrListListPredicate) Xor(p2 Uint16OptionArrListListPredicate) Uint16OptionArrListListPredicate {
	return func(e Uint16OptionArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint32OptionArrListListPredicate) Xor(p2 Uint32OptionArrListListPredicate) Uint32OptionArrListListPredicate {
	return func(e Uint32OptionArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Uint64OptionArrListListPredicate) Xor(p2 Uint64OptionArrListListPredicate) Uint64OptionArrListListPredicate {
	return func(e Uint64OptionArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 UintptrOptionArrListListPredicate) Xor(p2 UintptrOptionArrListListPredicate) UintptrOptionArrListListPredicate {
	return func(e UintptrOptionArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 ByteOptionArrListListPredicate) Xor(p2 ByteOptionArrListListPredicate) ByteOptionArrListListPredicate {
	return func(e ByteOptionArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 RuneOptionArrListListPredicate) Xor(p2 RuneOptionArrListListPredicate) RuneOptionArrListListPredicate {
	return func(e RuneOptionArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Float32OptionArrListListPredicate) Xor(p2 Float32OptionArrListListPredicate) Float32OptionArrListListPredicate {
	return func(e Float32OptionArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Float64OptionArrListListPredicate) Xor(p2 Float64OptionArrListListPredicate) Float64OptionArrListListPredicate {
	return func(e Float64OptionArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Complex64OptionArrListListPredicate) Xor(p2 Complex64OptionArrListListPredicate) Complex64OptionArrListListPredicate {
	return func(e Complex64OptionArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 Complex128OptionArrListListPredicate) Xor(p2 Complex128OptionArrListListPredicate) Complex128OptionArrListListPredicate {
	return func(e Complex128OptionArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
func (p1 AnyOptionArrListListPredicate) Xor(p2 AnyOptionArrListListPredicate) AnyOptionArrListListPredicate {
	return func(e AnyOptionArrListList) bool { x := p1(e); y := p2(e); return (x || y) && !(x && y) }
}
